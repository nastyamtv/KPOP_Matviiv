...
//console.log("\n\n\n\n\n");
//console.log("task 4: ", task4(listOfUsers, 'age'));
...
//console.log("task 2:", listOfUsers);
//console.log("task 3:", task3(listOfUsers, 'Norway', 69, 'female', false));
//console.log("task 4: ", task4(listOfUsers, 'age'));
//console.log("task 5: ",task5(listOfUsers, "en"))
console.log("task 6: ",task6(task5(listOfUsers, "en"), listOfUsers))