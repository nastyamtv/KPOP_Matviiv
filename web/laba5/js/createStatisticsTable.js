...
export function createStatisticsTable(teachers) {
    ...
    trName.innerHTML = '<th>Name<img class="statistics-table-head-arrow" src="images/blue-arrow-down.png" arrow="arrow"></th>';
    ...
    trSpecialty.innerHTML = '<th>Speciality<img class="statistics-table-head-arrow" src="images/blue-arrow-down.png" arrow="arrow"></th>';
    ...
    trAge.innerHTML = '<th>Age<img class="statistics-table-head-arrow" src="images/blue-arrow-down.png" arrow="arrow"></th>';
    ...
    trGender.innerHTML = '<th>Gender<img class="statistics-table-head-arrow" src="images/blue-arrow-down.png" arrow="arrow"></th>';
    ...
    trNationality.innerHTML = '<th>Nationality<img class="statistics-table-head-arrow" src="images/blue-arrow-down.png" arrow="arrow"></th>';
    ...
    const existingThead = document.getElementById('table').getElementsByTagName('thead')[0];
